#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""OpenHouse - search for flats by crawling property portals, and receive telegram
...
from openhouse.logging import logger, configure_logging
...
from openhouse.time_utils import get_random_time_jitter, wait_during_period
...
def main():
    """Processes command-line arguments, loads the config, launches the OpenHouse"""
    # load config
    args = parse()
