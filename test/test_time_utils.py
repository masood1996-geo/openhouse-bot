...
from openhouse.time_utils import is_current_time_between, get_time_span_in_secs, wait_during_period
...
class TimeUtilsTest(unittest.TestCase):
    ...
    @patch("OpenHouse.time_utils.datetime", side_effect=lambda *args, **kw: dt(*args, **kw))
    ...
    @patch("OpenHouse.time_utils.sleep")
    @patch("OpenHouse.time_utils.datetime", side_effect=lambda *args, **kw: dt(*args, **kw))
