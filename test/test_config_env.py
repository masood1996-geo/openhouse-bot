...
"""
    ...
    def test_loads_config_from_env(self):
       with modified_environ(OPENHOUSE_DATABASE_LOCATION="test"):
         self.assertEqual("test", os.getenv('OPENHOUSE_DATABASE_LOCATION'))
    ...
    def test_overrides_url(self):
        ...
        with modified_environ(OPENHOUSE_TARGET_URLS="https://fish.com"):
    ...
    def test_is24_cookie(self):
        ...
        with modified_environ(OPENHOUSE_IS24_COOKIE="bbbb"):
