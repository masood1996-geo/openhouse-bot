    ...
    def get_connection(self):
        ...
        if connection is None:
            try:
                ...
                cur.execute('CREATE INDEX IF NOT EXISTS idx_processed_id ON processed(ID)')
                cur.execute('CREATE INDEX IF NOT EXISTS idx_exposes_created ON exposes(created)')
                cur.execute('CREATE INDEX IF NOT EXISTS idx_exposes_crawler ON exposes(crawler)')
