"""OpenHouse implementation for website"""
...
from openhouse.exceptions import BotBlockedException, UserDeactivatedException

class WebHunter(Hunter):
    """OpenHouse implementation for website. Designed to hunt all exposes from
